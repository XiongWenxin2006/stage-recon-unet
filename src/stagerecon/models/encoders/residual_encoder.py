"""Residual U-Net encoder using ResidualDoubleConv blocks."""
...
from stagerecon.models.blocks.conv_blocks import ActivationType, NormType, get_pool_nd
...
class ResidualEncoder(BaseEncoder):
    """Contracting path with residual DoubleConv blocks and max-pooling."""
