"""Residual U-Net decoder using ResidualDoubleConv blocks."""
...
from stagerecon.models.blocks.conv_blocks import ActivationType, NormType, get_upsample_nd
...
class ResidualDecoder(BaseDecoder):
    """Upsample + skip-concat + ResidualDoubleConv at each level."""
    ...
    def decode(
        ...
        """Upsample the bottleneck with residual convolution blocks.
